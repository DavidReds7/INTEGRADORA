...
<div class="d-flex-wrapper">
    <header>
        <div class="header-content">
            ...
            <img src="${pageContext.request.contextPath}/img/headerWave.png" alt="Header Waves" class="img-fluid">
        </div>
    </header>
    ...
    <div class="flex-grow-1 container-xl table-responsive p-2 text-center" style="width: 82rem">
        <table id="example" class="table table-striped table-hover table-bordered mt-3" style="width: 100%">
            ...
            <tr>
                ...
                <td><a href="updateUser?id=<%= u.getId() %>">Actualizar</a></td>
                <td><a href="disableUser?id=<%= u.getId() %>">Inhabilitar</a></td>
                <td><a href="deleteUser?id=<%= u.getId() %>">Eliminar</a></td>
            </tr>
            <% } %>
            </tbody>
        </table>
    ...
    <footer>
        <img src="${pageContext.request.contextPath}/img/footerWaves.png" alt="Footer waves" class="img-fluid">
    </footer>
</div>
