        ...
        <form class="needs-validation" action="registrarActivo" novalidate>
            <div class="row mb-3"> <!-- Fila 1 -->
                <div class="col mb-3"> <!-- Columna 1 -->
                    ...
                    <input type="text" class="form-control" id="codigoAct" name="codigoAct" maxlength="20" required>
                ...
                <div class="col"> <!-- Columna 2 -->
                    ...
                    <input type="text" class="form-control" id="nombreAct" name="nombreAct" maxlength="20" required>
                ...
                <div class="col"> <!-- Columna 3 -->
                    ...
                    <input type="text" class="form-control" id="espeAct" name="espeAct" maxlength="50" required>
            ...
            <div class="row mb-3"> <!-- Fila 2 -->
                <div class="col mb-3"> <!-- Columna 1 -->
                    ...
                    <input type="text" class="form-control" id="marcaAct" name="marcaAct" maxlength="20" required>
                    <div class="invalid-feedback">Ingresa la marca</div>
                </div>

                <div class="col"> <!-- Columna 2 -->
                    <label for="modAct" class="form-label">Modelo:</label>
                    <input type="text" class="form-control" id="modAct" name="modAct" maxlength="20" required>
                    <div class="invalid-feedback">Ingresa el modelo</div>
                </div>

                <div class="col"> <!-- Columna 3 -->
                    <label for="numAct" class="form-label">No. Serie:</label>
                    <input type="text" class="form-control" id="numAct" name="numAct" maxlength="50" required>
            ...
            <div class="row mb-3"> <!-- Fila 3 -->
                <div class="col mb-3"> <!-- Columna 1 -->
                    ...
                    <input type="text" class="form-control" id="obsAct" name="obsAct" maxlength="100">
                </div>

                <div class="col"> <!-- Columna 2 -->
                    <label for="descripAct" class="form-label">Descripción:</label>
                    <input type="text" class="form-control" id="descripAct" name="descripAct" maxlength="100" required>
            ...
            <div class="row mb-3"> <!-- Fila 4 -->
                ...
                <div class="col mt-2 text-center align-content-center"> <!-- Columna 3 -->
                    ...
                    <button type="submit" class="btn gradient-button mb-0" style="width: 24rem;">Agregar</button>
                </div>
            </div>
